...
PROPERTY_NAMES = [ "temperature", "humidity", "wind_speed", "wind_dir", "rain", "sun", "battery" ]

class SourcePakbus (Source):
    def __init__(self, property_names: list[str] = PROPERTY_NAMES):
        #--------------------------------------------------------------
